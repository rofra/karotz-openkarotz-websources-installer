...
var sfr  = trim(params[instanceName].sfr);
var pwd  = trim(params[instanceName].password);
var type = trim(params[instanceName].type);
var maxi = trim(params[instanceName].maxi);

var url = 'https://karotz.wizz.cc/_appz/sfr/index.php?lang=fr&sfr='+sfr+'&pwd='+pwd+'&type='+type+'&maxi='+maxi;
var mp3 = 'http://www.wizz.cc/karotz/_mp3/sfr.mp3';
