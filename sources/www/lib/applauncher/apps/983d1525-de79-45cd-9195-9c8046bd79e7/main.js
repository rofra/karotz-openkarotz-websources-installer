...
var free = trim(params[instanceName].free);
var pwd  = trim(params[instanceName].password);
var type = trim(params[instanceName].type);
var maxi = trim(params[instanceName].maxi);

var url = 'https://karotz.wizz.cc/_appz/free/index.php?lang=fr&free='+free+'&pwd='+pwd+'&type='+type+'&maxi='+maxi;
var mp3 = 'http://www.wizz.cc/karotz/_mp3/free.mp3';
