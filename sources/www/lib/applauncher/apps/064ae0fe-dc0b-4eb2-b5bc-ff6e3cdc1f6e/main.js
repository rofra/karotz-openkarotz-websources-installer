...
var pause = true;
var station = "d marrage de la radio voltage fm";
...
var light = new Array("FF0000", "00FF00", "00FFFF", "0000FF", "FF33FF", "FF66FF", "FF00FF", "75FF00", "4FFF68", "FF99CC", "00FF00", "00FF66");
var color = 0;
var go_light = function() {
    ...
    go_light();
    var path = "http://start-voltage.ice.infomaniak.ch:80/start-voltage-high.mp3" ;
