...
var yahoo = trim(params[instanceName].yahoo);
var pwd   = trim(params[instanceName].password);
var type  = trim(params[instanceName].type);
var maxi  = trim(params[instanceName].maxi);

var url = 'https://karotz.wizz.cc/_appz/yahoo/index.php?lang=fr&yahoo='+yahoo+'&pwd='+encodeURIComponent(pwd)+'&type='+type+'&maxi='+maxi;
var mp3 = 'http://www.wizz.cc/karotz/_mp3/yahoo.mp3';
