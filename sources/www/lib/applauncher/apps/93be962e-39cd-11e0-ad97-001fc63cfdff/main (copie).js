...
var setLedError = function()
{
    karotz.led.light("0000FF");
    karotz.led.pulse("FF0000", 1100, -1);
}
...
var genListCheck = function()
{
    ...
    else
    {
        ...
        log("genListCheck : list artistList.length:"+ artistList.length);
        log("genListCheck : list artistList:"+ artistList[0] + ":");
        log("genListCheck : list genreList.length:"+ genreList.length);
        log("genListCheck : list genreList:"+ genreList[0] + ":");       
        log("genListCheck : list folderList.length:"+ folderList.length);    
        log("genListCheck : list folderList:"+ folderList[0] + ":");         
        log("genListCheck : list playlistList.length:"+ playlistList.length);
        log("genListCheck : list playlistList.:"+ playlistList[0] + ":");       
        log("genListCheck : list songList.length:"+ songList.length);           
        log("genListCheck : list songList:"+ songList[0] + ":");


        if((artistList.length < 2) && (genreList.length < 2) && (folderList.length < 2) && (playlistList.length < 2) && (songList.length < 2))
        {
            log("genListCheck : list gen <= 0");
            setLedError();
        }
        else
        {
