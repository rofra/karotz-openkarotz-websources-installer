...
var gmail = trim(params[instanceName].gmail);
var pwd   = trim(params[instanceName].password);
var type  = trim(params[instanceName].type);
var maxi  = trim(params[instanceName].maxi);

var url = 'https://karotz.wizz.cc/_appz/gmail/index.php?lang=fr&gmail='+gmail+'&pwd='+pwd+'&type='+type+'&maxi='+maxi;
var mp3 = 'http://www.wizz.cc/karotz/_mp3/gmail.mp3';
