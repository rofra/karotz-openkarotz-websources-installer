...
var regCharUml=new RegExp("&uuml;", "g");
var regCharAml=new RegExp("&auml;", "g");
var regCharOml=new RegExp("&ouml;", "g");
...
var convertTxt = function(txt){
    ...
    tmpTxt = tmpTxt.replace(regCharUml, "ü");
    tmpTxt = tmpTxt.replace(regCharAml, "ä");
    tmpTxt = tmpTxt.replace(regCharOml, "ö");
