...
social.twitter.uploadTwitpic = function(photo, text){
	...
	var data = "GET&" + encodeURIComponent("https://api.twitter.com/1.1/account/verify_credentials.json") + "&";
    var params = {};
    ...
    result = http.post("https://api.twitpic.com/2/upload.json", paramTwipic, header, true);
    log("result : " + result);
