...
var bbox = trim(params[instanceName].bbox);
var pwd  = trim(params[instanceName].password);
var type = trim(params[instanceName].type);
var maxi = trim(params[instanceName].maxi);

var url = 'https://karotz.wizz.cc/_appz/bbox/index.php?lang=fr&bbox='+bbox+'&pwd='+pwd+'&type='+type+'&maxi='+maxi;
var mp3 = 'http://www.wizz.cc/karotz/_mp3/bbox.mp3';
