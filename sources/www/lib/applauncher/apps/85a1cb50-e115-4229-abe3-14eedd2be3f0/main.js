...
var orange = trim(params[instanceName].orange);
var pwd  = trim(params[instanceName].password);
var type = trim(params[instanceName].type);
var maxi = trim(params[instanceName].maxi);

var url = 'https://karotz.wizz.cc/_appz/orange/index.php?lang=fr&orange='+orange+'&pwd='+pwd+'&type='+type+'&maxi='+maxi;
var mp3 = 'http://www.wizz.cc/karotz/_mp3/orange.mp3';
